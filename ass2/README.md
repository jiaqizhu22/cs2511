...
We worked collaboratively on the epic stories and user stories via Google Doc on Saturday night of week 5. (50%:50%)

### Week-06

We started the issue board and labels. We worked together and recursively on the backend classes and interfaces. 

### Week-07

We worked on the tests and backend methods.

### Week-08

We worked on and tried to improve the backend, achieved milestone 2. We started coding on the frontend.

### Week-09

We worked together on the frontend of the dungeon game. We splited .fxml and .java files and edited stuff recursively. We fixed bugs in the backend and frontend.
